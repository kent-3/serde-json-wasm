...
impl<'serializer, 'indent: 'serializer> ser::SerializeStruct for SerializeStruct<'serializer, 'indent> {
    type Ok = ();
    type Error = Error;
...
impl<'serializer, 'indent: 'serializer> ser::SerializeStructVariant for SerializeStruct<'serializer, 'indent> {
    type Ok = ();
    type Error = Error;
